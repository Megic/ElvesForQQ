...
<title>ElvesCMS－QQ登录插件安装/卸载程序</title>
<style>
...
<form method="GET" action="index.php" name="formupdate" onsubmit="return CheckUpdate(document.formupdate);">
  ...
  <table width="500" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#4FB4DE">
    <tr> 
      <td height="30" colspan="2"> <div align="center"><strong><font color="#FFFFFF">ElvesCMS－QQ登录插件安装/卸载程序</font></strong></div></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td> <input type=submit name=updatebutton value="提交操作"> <input name="elve" type="hidden" id="elve" value="install"> 
      </td>
    </tr>
  </table>
  </form>
